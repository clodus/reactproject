...
/* =========================
   COMPONENT PRINCIPAL
========================= */
export default function Gantt({ data }: Props) {
    const [dataGantt, setData] = useState<Resource[]>(data); // ← initialiser directement
  ...
  const handleResize = useCallback((id: number, newStart: string, newEnd: string) => {
    setData((prev) =>
      prev.map((resource) => ({
        ...resource,
        assignments: resource.assignments.map((a) =>
          a.id === id
  ...
  return (
    <div style={{ padding: 20, fontFamily: "sans-serif" }}>
      ...
      >
          ...
          <thead>
            <tr>
              ...
              >
                ...
                const background = isToday ? "#fde68a" : isWeekend ? "#e5e7eb" : "#fafafa";
              ...
              <tr key={resource.id}>
                ...
                return (
                    ...
                    style={{
                        ...
                        padding: 0,
                        boxSizing: "border-box",
                        background: isWeekend ? "#e5e7eb" : "white",
                    }}
                    />
                );
                })}
        ...
        >
          {dataGantt.map((resource, rowIndex) =>
